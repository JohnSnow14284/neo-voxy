...
public abstract class AbstractRenderPipeline extends TrackedObject {
    ...
    /**
     * Depth generated by an off-screen LOD pipeline that has not yet been committed to the
     * active Minecraft framebuffer. External transformed-geometry renderers can use this to
     * participate in the same depth test. Zero means the active framebuffer already owns the
     * relevant depth, or that no compatible texture is available.
     */
