...
public class SoftwareRasterizer {
    ...
    private void rasterTriangle(boolean orZero) {
        ...
        // Pretty sure this is how you check for winding order as well
        // (if area is negative it is counterclockwise).  Alpha-cutout quads are
        // often two-sided plant/cross quads; culling them during the offline bake
        // makes some modded ground plants disappear from one or more Voxy views.
